...
namespace FACe.Xml
{
    ...
    /// </summary>
    public class FacturaeNamespaces
    {

        #region Propiedades Públicas Estáticas

        /// <summary>
        /// Prefijo de espacios de nombres http://www.facturae.gob.es/formato/Versiones/.  
        /// </summary>
        public const string NamespacePrefix = "http://www.facturae.gob.es/formato/Versiones/";

        /// <summary>
        /// Espacio de nombres FE (fe)
        /// </summary>
        public const string NamespaceFE = "http://www.facturae.es/Facturae/2009/v3.2/Facturae";   
