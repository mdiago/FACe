...
namespace FACe.Xml.Xades.Signature.Xades.Props
{
    ...
    internal class SignaturePolicyId : PropXmlElement
    {
        ...
        internal SignaturePolicyId(XmlNode parent) : base(parent, "SignaturePolicyId")
        {
            ...
            SigPolicyId.Identifier.Value = XadesSigned.SigPolicyId;

            if (XadesSigned.SigPolicyQualifier != null)
            {
                SigPolicyQualifiers = new SigPolicyQualifiers(XmlElement);
                SigPolicyQualifiers.SigPolicyQualifier.SPURI.Value = XadesSigned.SigPolicyQualifier;
            }
