...
namespace FACe.Xml.Xades.Signature.Xades.Props
{
    ...
    internal class SignedProperties : PropertyElementWithSigId
    {
        ...
        internal SignedProperties(XmlNode parent, string referenceId) : base(parent, "SignedProperties")
        {

            SignedSignatureProperties = new SignedSignatureProperties(XmlElement);
            SignedDataObjectProperties = new SignedDataObjectProperties(XmlElement, referenceId);
