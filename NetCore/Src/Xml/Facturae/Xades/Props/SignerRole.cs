...
namespace FACe.Xml.Xades.Signature.Xades.Props
{
    ...
    /// SignerRole.
    /// </summary>
    internal class SignerRole : PropXmlElement
    {
        ...
        /// SignerRole.
        /// </summary>
        internal ClaimedRoles ClaimedRoles { get; private set; }
        ...
        internal SignerRole(XmlNode parent) : base(parent, "SignerRole")
        {

            ClaimedRoles = new ClaimedRoles(XmlElement);
