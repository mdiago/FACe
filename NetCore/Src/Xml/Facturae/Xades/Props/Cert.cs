...
using FACe.Xml.Xades.Signature.Xades.Props.BigInt;
using System;
    ...
    internal class Cert : PropXmlElement
    {
        ...
        internal X509Certificate2 Certificate
        {
            ...
            set
            {
                ...
                _Certificate = value;
                CertDigest.DigestValue.Value = Convert.ToBase64String(new SHA512Managed().ComputeHash(value.RawData));
                IssuerSerial.X509IssuerName.Value =  Rfc2253IssuerFormatter.FromCertificate(_Certificate, replaceSwithST: true);
