...
namespace FACe.Xml.Xades.Signature.Xades.Props
{
    ...
    internal class QualifyingProperties : PropertyElementWithSigId
    {
        ...
        internal QualifyingProperties(XmlNode parent, string referenceId) : base(parent, "QualifyingProperties")
        {

            SignedProperties = new SignedProperties(XmlElement, referenceId);
