...
namespace FACe.Xml.Xades.Signature.Xades.Props
{
    ...
    internal class Signature : PropXmlElement
    {
        ...
        /// <param name="referenceId">Referencia objeto a firmar.</param>
        internal Signature(XmlNode parent, string referenceId) : base(parent, "Signature", "ds", "http://www.w3.org/2000/09/xmldsig#")
        {

            XmlElement.SetAttribute("xmlns:ds", "http://www.w3.org/2000/09/xmldsig#");
            Object = new Object(XmlElement, referenceId);
