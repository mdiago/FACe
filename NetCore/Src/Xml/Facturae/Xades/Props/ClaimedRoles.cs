...
namespace FACe.Xml.Xades.Signature.Xades.Props
{
    ...
    /// ClaimedRoles.
    /// </summary>
    internal class ClaimedRoles : PropXmlElement
    {
        ...
        /// ClaimedRolse.
        /// </summary>
        internal ClaimedRole ClaimedRole { get; private set; }
        ...
        internal ClaimedRoles(XmlNode parent) : base(parent, "ClaimedRoles")
        {

            ClaimedRole = new ClaimedRole(XmlElement);
            ClaimedRole.Value = "emisor";
