...
namespace FACe.Xml.Facturae.Bies
{
    ...
    /// <summary>
    /// Datos factoring versión 3.22.
    /// </summary>
    [Serializable()]
    [XmlType(Namespace = FacturaeNamespaces.NamespaceFE)]
    public class FactoringAssignmentData
    {

        #region Propiedades Públicas Estáticas

        /// <summary>
        /// Interlocutor comericial al que se le
        /// asigna el factoring.
        /// </summary>
        ...
        public FactoringAssignmentDocument[] FactoringAssignmentDocument { get; set; }
