...
namespace FACe.Xml.Facturae.Bies
{
    ...
    public class ReimbursableExpenses
    {
        ...
        public TaxIdentification ReimbursableExpensesSellerParty { get; set; }

        /// <summary>
        /// Comprador.
        /// </summary>
        [XmlElement(Form = XmlSchemaForm.Unqualified)]
        public TaxIdentification ReimbursableExpensesBuyerParty { get; set; }
