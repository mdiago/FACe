...
namespace FACe.Xml.Facturae.Bies
{
    ...
    /// <summary>
    /// Totales de factura versión 3.2.2.
    /// </summary>
    [Serializable()]
    [XmlType(Namespace = FacturaeNamespaces.NamespaceFE)]
    public class InvoiceTotals : InvoiceTotalsBase
    {
        ...
        public Discount[] GeneralDiscounts { get; set; }
        ...
        public Charge[] GeneralSurcharges { get; set; }
        ...
        public PaymentOnAccount[] PaymentsOnAccount { get; set; }
        ...
        /// <summary>
        /// True se incluye TotalFinancialExpenses.
        /// </summary>
        [XmlIgnore()]
        ...
        /// <summary>
        /// True se incluye TotalPaymentsOnAccount.
        /// </summary>
        [XmlIgnore()]
