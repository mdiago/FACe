...
namespace FACe.Config
{
	...
	public class Settings
	{
		...
		static readonly string _Path =
            ...
            Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + $"{_PathSep}FACe{_PathSep}" :
#endif
            Environment.GetFolderPath(Environment.SpecialFolder.CommonApplicationData) + $"{_PathSep}FACe{_PathSep}";
        ...
        internal static Settings GetDefault() 
        {
            ...
            return new Settings()
            {
                ...
                {
                    FACeEndPointPrefix = FACeEndPointPrefixes.Test,
                },
                Api = new Api()
                {
        ...
        /// <summary>
        /// Configuración API REST FACe.
        /// </summary>
        [XmlElement("FACeSettings")]
        public FACeSettings FACeSettings { get; set; }

        /// <summary>
        /// Datos del API REST para FACe de Irene Solutions.
        /// </summary>
        [XmlElement("Api")]
