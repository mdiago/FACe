...
namespace FACe.Providers.Api
{
    ...
    /// <summary>
    /// Archivo anexo a un envío a FACe
    /// de un documento Facturae.
    /// </summary>
    public class InvoiceEntryAttachment : JsonSerializable
    {

        /// <summary>
        /// (string, opcional): nombre del anexo.
        /// </summary>
        [Json(Name = "filename")]
        public string FileName { get; set; }

        /// <summary>
        /// (string, opcional): PDF o HTML del anexo
